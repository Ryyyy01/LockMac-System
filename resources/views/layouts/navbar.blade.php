<div class="bg-f07 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        <span class="font-semibold text-sm sm:text-xl tracking-tight">LockMac</span>
    </div>
    <div class="relative">
        @auth
